...
namespace BOOKSTORE
{
    public partial class CATARLOGUE : Form
    {
        ...
        {
            conn = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\nomfusi kibido\Desktop\Book store app.accdb");
